import { resources, Asset, __private, Constructor, js, AssetManager, assetManager } from 'cc';
...
/**
 * @ Author: zhengxinpeng
 * @ Create Time: 2022-11-16 14:44:46
 * @ Description:资源加载(兼容加载接口)
 */
export default class ResLoader {
    private static instance: ResLoader | null = null;
